...
| incremental_strategy   | Incremental model update strategy: `default`, `delete+insert`, `append`, or `insert+replace`.  See the following Incremental Model Strategies                                                                                                                                      | `default`      |
